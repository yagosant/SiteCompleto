...
//imovel const imovel/12/titulo_imovel
...
Route::post('/admin/usuarios/papel/remover/{id}/{papel_id}', ['as' => 'admin.usuarios.papel.remover', 'uses' => 'Admin\UsuarioController@removerPapel']);    


//rota para manutenção das páginas
